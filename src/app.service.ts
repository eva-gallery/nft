...
export class AppService {
  ...
  async testCreateSwapCall(): Promise<Extrinsic> {
    const nft: SwapDto = { address: '13TrdLhMVLcwcEhMYLcqrkxAgq9M5gnK1LZKAF4VupVfQDUg' };
  ...
  async testCreateNft(): Promise<Extrinsic> {
    const nft: NftDto = { metadata: {name: 'mockedName', description: 'mockedDescription', ipfs: 'mockedIpfs', author: '13TrdLhMVLcwcEhMYLcqrkxAgq9M5gnK1LZKAF4VupVfQDUg' } };
    const collectionID = 1;
    const assetID = 1;
  ...
  async testCreateCol(): Promise<Extrinsic> {
    const collectionMeta = { name: 'mockedName', description: 'mockedDescription', ipfs: 'mockedIpfs' };
    const collectionDto: CollectionDto = { owner: '13TrdLhMVLcwcEhMYLcqrkxAgq9M5gnK1LZKAF4VupVfQDUg', metadata: collectionMeta };
