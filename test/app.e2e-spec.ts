...
describe("App E2E Tests", () => {
  ...
  it("/nft (GET)", () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .expect(
        '""',
      );
  });
  ...
  it("/collection (GET)", () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .expect(
        '""',
      );
  });
