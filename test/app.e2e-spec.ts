...
describe('App E2E Tests', () => {
  ...
  beforeAll(async () => {
    const moduleFixture: TestingModule = await Test.createTestingModule({
      imports: [AppModule, NFTModule, CollectionModule, SwapModule, MetadataModule],
    }).compile();
  ...
  it('/nft (GET)', () => {
    return request(app.getHttpServer())
      .get('/test-create-nft')
      .expect(200)
      .expect('""');
  });
  ...
  it('/collection (GET)', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .expect('""');
  });
  ...
  it('/swap (GET)', () => {
    return request(app.getHttpServer())
      ...
      .expect(200)
      .expect('"0xb00434060100000001000000006cf3e7bf1cc5f0b87e7aaa8bc5acf2489651b14e768bcf5d9206f878778f4404"');
  });
